...
VARIANT_KEY_TEST variant_tests [] = { {
	...
	{ 0xA6, 0xED, 0xB2},
	{ 0x25, 0x70, 0xA9, 0x54, 0x61, 0xEC, 0xCD, 0x0D, 0x56, 0xA3, 0xAF, 0x03, 0x5F, 0xE0, 0xB9, 0x85 } },
	...
	{ 0xA6, 0xED, 0xB2},
	{ 0x25, 0x70, 0xA9, 0x54, 0x61, 0xEC, 0xCD, 0x0D, 0x56, 0xA3, 0xAF, 0x03, 0x5F, 0xE0, 0xB9, 0x85,
			0x95, 0x97, 0x40, 0xCC, 0xAF, 0x67, 0xC7, 0x51 } }
};
...
void test_variant() {
	...
	for (size_t i = 0; i<sizeof(variant_tests)/sizeof(VARIANT_KEY_TEST); i++) {
		...
		print_array("\tClear-text key: ", p->key, p->key_len, "\n");
